...
<View style={styles.top}>
    ...
    <TouchableOpacity style={{marginBottom: 14, height : 32,width : 32, borderRadius : 5, marginLeft : 270, marginTop : 12 , backgroundColor : 'white'}}
      onPress = { () => this.navigation.navigate("Ttesting")}>
...
<View style={styles.referral}>
  ...
  <Text style = {{marginTop : 15 , marginLeft : 12 , fontSize : 16 , color : '#584f58'}}>Complete your <Text style={{color : '#ef8947'}}>personal information</Text> and </Text>
...
<View style={{marginBottom: 30, flex: 0.8, backgroundColor : '#ffffff', elevation : 4, borderBottomLeftRadius : 20, borderBottomRightRadius : 20, marginRight : 15, marginLeft :30}}>
